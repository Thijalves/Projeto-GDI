...
CONSTRAINT CHK_ATAQUE CHECK (ATAQUE BETWEEN 0 AND 150), 
 
CONSTRAINT CHK_DEFESA CHECK (DEFESA BETWEEN 0 AND 150) 
...
CONSTRAINT CHK_ATAQUE_POKE CHECK (ATK BETWEEN 0 AND 150),  
 
CONSTRAINT CHK_DEFESA_POKE CHECK (DEF BETWEEN 0 AND 150)  
...
INSERT INTO ESPECIE (ID, NOME, TIPO, ATAQUE, DEFESA, ALTURA, PESO)
VALUES (1, 'Charizard', 'FOGO', 95, 85, 1.7, 90);

INSERT INTO ESPECIE (ID, NOME, TIPO, ATAQUE, DEFESA, ALTURA, PESO)
VALUES (2, 'Bulbasaur', 'PLANTA', 65, 70, 0.7, 6);

INSERT INTO ESPECIE (ID, NOME, TIPO, ATAQUE, DEFESA, ALTURA, PESO)
VALUES (3, 'Squirtle', 'AGUA', 50, 65, 0.5, 9);

INSERT INTO ESPECIE (ID, NOME, TIPO, ATAQUE, DEFESA, ALTURA, PESO)
VALUES (4, 'Pikachu','ELETRICO', 55, 40, 0.4, 6);

INSERT INTO ESPECIE (ID, NOME, TIPO, ATAQUE, DEFESA, ALTURA, PESO)
VALUES (5, 'Dragonite', 'DRAGAO', 34, 95, 2.2, 10);

INSERT INTO ESPECIE (ID, NOME, TIPO, ATAQUE, DEFESA, ALTURA, PESO)
VALUES (6, 'Mewtwo', 'PSIQUICO', 10, 90, 2, 22);

INSERT INTO ESPECIE (ID, NOME, TIPO, ATAQUE, DEFESA, ALTURA, PESO)
VALUES (7, 'Snorlax', 'NORMAL', 10, 65, 2.1, 60);

INSERT INTO ESPECIE (ID, NOME, TIPO, ATAQUE, DEFESA, ALTURA, PESO)
VALUES (8, 'Gyarados', 'AGUA', 55, 9, 6.5, 35);

INSERT INTO ESPECIE (ID, NOME, TIPO, ATAQUE, DEFESA, ALTURA, PESO)
VALUES (9, 'Lucario','LUTADOR', 10, 70, 1.2, 54);

INSERT INTO ESPECIE (ID, NOME, TIPO, ATAQUE, DEFESA, ALTURA, PESO)
VALUES (10, 'Vaporeon', 'AGUA', 65, 60, 1, 29);

INSERT INTO ESPECIE (ID, NOME, TIPO, ATAQUE, DEFESA, ALTURA, PESO)
VALUES (11, 'Blaziken', 'FOGO', 20, 70, 1.9, 52);

INSERT INTO ESPECIE (ID, NOME, TIPO, ATAQUE, DEFESA, ALTURA, PESO)
VALUES (12, 'Gengar', 'FANTASMA', 75, 65, 1.5, 40);

INSERT INTO ESPECIE (ID, NOME, TIPO, ATAQUE, DEFESA, ALTURA, PESO)
VALUES (13, 'Tyranitar', 'PEDRA', 34, 10, 2, 2);
...
INSERT INTO POKEMON (DESCRITOR, CPF, ID, ATK, DEF, HEI, WEI) VALUES	(3, 10, 1, 150, 150, 1.043, 62);

INSERT INTO POKEMON (DESCRITOR, CPF, ID, ATK, DEF, HEI, WEI) VALUES	(4, 10, 1, 70, 80, 1.179, 95);

INSERT INTO POKEMON (DESCRITOR, CPF, ID, ATK, DEF, HEI, WEI) VALUES	(10, 6, 1, 98, 80, 1.179, 95);
